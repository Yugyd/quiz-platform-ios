...
private let segueCoursesToCourseDetails = "segueCoursesToCourseDetails"
private let segueCoursesToSubCourses = "segueCoursesToSubCourses"
...
class CoursesViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.title = String(localized: "course_list_title", table: appLocalizable)
    ...
    private func createHostController() -> UIHostingController<CoursesScreen> {
        viewModel = CoursesViewModel(
            courseInteractor: IocContainer.app.resolve(),
            logger: IocContainer.app.resolve()
        )
        
        let view = CoursesScreen(
            viewModel: viewModel,
            onNavigateToSubCourse: { [weak self] subCourseArgs in
                self?.performSegue(
                    withIdentifier: segueCoursesToSubCourses,
            ...
            onNavigateToCourseDetails: { [weak self] courseId, courseTitle in
                self?.performSegue(
                    withIdentifier: segueCoursesToCourseDetails,
